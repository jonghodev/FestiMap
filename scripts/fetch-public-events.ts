#!/usr/bin/env tsx
/**
 * 공공 API에서 행사 데이터를 가져와 데이터베이스에 저장하는 스크립트
 *
 * 사용법:
 *   npm run events:fetch
 *   # 또는
 *   tsx scripts/fetch-public-events.ts
 *
 * 필요 환경변수 (.env.local에 추가):
 ...
 *
 * 동작 방식:
 *   1. 공공 API에서 서울/수도권 행사 데이터를 가져옵니다
 *   2. sourceId 기준으로 중복을 제거합니다 (upsert)
 *   3. 새로운 행사는 추가, 기존 행사는 업데이트합니다
 *   4. API 키가 없으면 해당 API는 건너뜁니다
 */
...
// .env.local 파일 수동 로드 (Next.js 밖에서 실행 시 필요)
function loadEnvFile(filePath: string) {
  try {
    const content = dotenv.readFileSync(filePath, 'utf-8');
...
// ────────────────────────────────────────────────────────────────
// 큐레이션 이벤트 (API 키가 없을 때 기본 데이터)
// ────────────────────────────────────────────────────────────────
// 이 데이터는 prisma/seed.ts와 동일한 50+ 큐레이션 이벤트입니다.
// API에서 가져온 데이터와 병합됩니다.
const CURATED_EVENTS: PublicEventRaw[] = [
  ...
  },
  {
    ...
    description: '광화문 광장 일대를 화려한 빛으로 물들이는 겨울 축제.',
  ...
  },
  {
    ...
    description: '세계 각국의 불꽃팀이 참가하는 국제 불꽃 경연대회.',
    eventType: 'FESTIVAL', startDate: new Date('2026-10-03'), endDate: new Date('2026-10-03'),
  ...
  },
  {
    ...
    description: '홍대 앞 거리에서 열리는 인디뮤지션들의 음악 축제.',
  ...
  },
  {
    ...
    description: '다양한 먹거리를 즐길 수 있는 푸드트럭 축제.',
  ...
  },
  {
    ...
    description: '전통 한옥마을에서 열리는 문화 축제.',
  ...
  },
  {
    ...
    description: '세계 각국의 문화를 체험할 수 있는 다문화 축제.',
  ...
  },
  {
    ...
    description: '잠실종합운동장 일대에서 열리는 봄 벚꽃 축제.',
  ...
  },
  {
    ...
    description: '성북동의 문화재와 골목길을 야간에 걷는 야행 프로그램.',
  ...
  },
  {
    ...
    description: '송도 센트럴파크에서 열리는 국제 맥주 축제.',
  ...
  },
  {
    ...
    description: '유네스코 세계문화유산 수원 화성에서 열리는 전통 문화 축제.',
  ...
  },
  {
    ...
    description: '세계 각국의 드럼 연주자들이 참여하는 음악 축제.',
  ...
  },
  {
    ...
    description: '강동구 암사동 선사 유적지에서 열리는 선사 문화 축제.',
  ...
  },
  {
    ...
    description: '중랑천 장미공원에서 열리는 봄 장미 축제.',
  ...
  },
  {
    ...
    description: '남산골 한옥마을에서 펼쳐지는 전통문화 한마당.',
  ...
  // 플리마켓 (FLEA_MARKET)
  {
    ...
    description: '매주 주말 한강변에서 열리는 플리마켓.',
  ...
  },
  {
    ...
    description: '홍대 앞 놀이터에서 매주 토요일 열리는 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-03-28'), endDate: new Date('2026-11-30'),
  ...
  },
  {
    ...
    description: '인사동 쌈지길에서 열리는 주말 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-03-28'), endDate: new Date('2026-11-30'),
  ...
  },
  {
    ...
    description: '성수동 수제화 거리에서 열리는 빈티지 플리마켓.',
  ...
  },
  {
    ...
    description: '동묘 앞 구제 시장과 함께하는 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-03-28'), endDate: new Date('2026-11-30'),
  ...
  },
  {
    ...
    description: '별마당 도서관에서 열리는 책과 문화 플리마켓.',
  ...
  },
  {
    ...
    description: '뚝섬한강공원에서 열리는 주말 플리마켓.',
  ...
  },
  {
    ...
    description: '망원동에서 열리는 빈티지 및 핸드메이드 상품 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-04-04'), endDate: new Date('2026-11-28'),
  ...
  },
  {
    ...
    description: '서울숲 공원에서 열리는 친환경 플리마켓.',
  ...
  },
  {
    ...
    description: '신사동 가로수길에서 열리는 아트 마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-04-11'), endDate: new Date('2026-11-28'),
  ...
  },
  {
    ...
    description: '광장시장 인근에서 열리는 주말 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-03-28'), endDate: new Date('2026-11-30'),
  ...
  },
  {
    ...
    description: '경의선 숲길에서 열리는 책 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-04-04'), endDate: new Date('2026-11-28'),
  ...
  },
  {
    ...
    description: '은평 뉴타운 광장에서 열리는 지역 주민 플리마켓.',
  ...
  },
  {
    ...
    description: '수원 행리단길에서 열리는 인디 브랜드 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-04-11'), endDate: new Date('2026-11-28'),
  ...
  },
  {
    ...
    description: '부천 중앙공원에서 열리는 지역 주민 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-04-11'), endDate: new Date('2026-10-31'),
  ...
  },
  {
    ...
    description: '이촌 한강공원에서 열리는 가족 친화적인 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-04-11'), endDate: new Date('2026-10-31'),
  ...
  },
  {
    ...
    description: '문화비축기지에서 열리는 특별 마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-04-11'), endDate: new Date('2026-10-31'),
  ...
  },
  {
    ...
    description: '성동구 도시재생 공간에서 열리는 창업 플리마켓.',
    eventType: 'FLEA_MARKET', startDate: new Date('2026-04-11'), endDate: new Date('2026-11-28'),
  ...
  // 야시장 (NIGHT_MARKET)
  {
    ...
    description: '여의도한강공원에서 열리는 밤도깨비 야시장.',
  ...
  },
  {
    ...
    description: '반포한강공원에서 열리는 밤도깨비 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-04-03'), endDate: new Date('2026-10-31'),
    venue: '반포한강공원', address: '서울특별시 서초구 신반포로11길 40',
    latitude: 37.5096, longitude: 126.9959, district: '서초구', city: '서울특별시',
    imageUrl: null, sourceUrl: null, isFree: true, price: null, organizer: '서울시',
  },
  {
    ...
    description: '청계광장에서 열리는 밤도깨비 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-04-03'), endDate: new Date('2026-10-31'),
  ...
  },
  {
    ...
    description: 'DDP 동대문디자인플라자 앞에서 열리는 밤도깨비 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-04-03'), endDate: new Date('2026-10-31'),
  ...
  },
  {
    ...
    description: '홍대 앞 클럽 데이에 함께 열리는 야시장.',
  ...
  },
  {
    ...
    description: '광장시장에서 밤에 더욱 활기차게 열리는 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-03-28'), endDate: new Date('2026-11-30'),
  ...
  },
  {
    ...
    description: '이태원 거리에서 매주 금·토·일 열리는 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-03-28'), endDate: new Date('2026-11-30'),
    venue: '이태원로 일대', address: '서울특별시 용산구 이태원로',
    latitude: 37.5344, longitude: 126.9940, district: '용산구', city: '서울특별시',
    imageUrl: null, sourceUrl: null, isFree: true, price: null, organizer: '용산구',
  },
  {
    ...
    description: '수원 화성 인근에서 열리는 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-04-03'), endDate: new Date('2026-10-31'),
  ...
  },
  {
    ...
    description: '인천 차이나타운에서 열리는 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-04-03'), endDate: new Date('2026-10-31'),
  ...
  },
  {
    ...
    description: '마포 홍어거리에서 매주 금·토 열리는 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-03-28'), endDate: new Date('2026-11-30'),
  ...
  },
  {
    ...
    description: '역삼 테헤란로에서 열리는 직장인 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-03-28'), endDate: new Date('2026-11-30'),
  ...
  },
  {
    ...
    description: '노원구 불암산 자락에서 열리는 지역 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-04-03'), endDate: new Date('2026-10-31'),
  ...
  },
  {
    ...
    description: '종로 피맛골에서 매주 금·토 열리는 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-03-28'), endDate: new Date('2026-11-30'),
  ...
  },
  {
    ...
    description: '해방촌 계단 거리에서 열리는 감성 야시장.',
    eventType: 'NIGHT_MARKET', startDate: new Date('2026-04-03'), endDate: new Date('2026-10-31'),
...
// ────────────────────────────────────────────────────────────────
async function main() {
  console.log('🌏 FestiMap 공공 API 데이터 가져오기 시작...\n');

  // 1. 공공 API에서 데이터 가져오기
  const { tourApiEvents, tourApiMarketEvents, tourApiAreaBasedEvents, seoulEvents, total } = await fetchAllPublicEvents();
  ...
  console.log(`  - 서울 열린데이터광장: ${seoulEvents.length}개`);
  console.log(`  - API 수집 소계: ${total}개`);
  console.log(`  - 큐레이션 데이터: ${CURATED_EVENTS.length}개`);

  // 2. 데이터 병합 (큐레이션 + API, sourceId 기준 중복 제거)
  const merged = mergeEventSources(CURATED_EVENTS, tourApiEvents, tourApiMarketEvents, tourApiAreaBasedEvents, seoulEvents);
  console.log(`\n✅ 중복 제거 후 총 행사 수: ${merged.length}개\n`);

  if (merged.length < 50) {
    console.warn(`⚠️  경고: 행사 수(${merged.length})가 50개 미만입니다.`);
  }
  ...
  console.log(`  - 총 행사: ${merged.length}개`);
